...
define( 'NEW_ACCOUNT_LANDING_PAGE', 'https://insight.strakertranslations.com/lingotek-freemium-upgrade-connectors' );
	...
	public function lingotek_plugin_migration() {
		...
		if ( $updates_have_run ) {
			...
			add_action(
                ...
                <p>' . __( 'Upgrades for the Ray Enterprise translation module have completed.', 'lingotek-translation' ) . '</p>
              </div>';
				}
			);
		}
