...
<div class="feature-section three-col">
	<div class="col">
		...
		<p><?php printf( __( 'Easily translate your site into new languages by adding the desired language to your site.  Ray Enterprise allows you to quickly add any of the most frequently used locales using the <a href="%s" title="Translation &gt; Dashboard">Translation Dashboard</a>.', 'lingotek-translation' ), 'admin.php?page=lingotek-translation' ); ?></p>
	</div>
	<div class="col">
...
<div class="col">
		...
		<p><?php printf( __( 'Polylang and Ray Enterprise work together seamlessly.  Continue to use Polylang for content that you want to translate inside WordPress, while sending other content to be translated by Ray Enterprise. The <b style="color: %1$s">orange</b> icons indicate Ray Enterprise statuses/actions while the <b style="color: %2$s">blue</b> icons continue to represent Polylang actions.', 'lingotek-translation' ), 'darkorange', '#0473a8' ); ?></p>
	</div>
	<div class="col">
