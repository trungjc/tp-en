...
<h4>
	<?php _e( 'What Does The Ray EnterpriseTranslation Plugin Do?', 'lingotek-translation' ); ?>
...
<p id="ltk-summary" style="display:none; margin-left: 25px;"><?php _e( 'Ray Enterprise works in conjunction with the Polylang plugin (the plumbing to make WordPress multilingual ready) simplifying the process of creating and maintaining your multilingual website. You write posts, pages, and create categories and post tags as usual, and then define the language for each of them.', 'lingotek-translation' ); ?></p>

<h4>
	<?php _e( 'Ray Enterprise Translation General Overview', 'lingotek-translation' ); ?>
...
<div id="gen-overview-tut" style="display:none;margin-left: 25px;">
	<div>
		...
		<p><?php _e( 'Whether you write a blog post, create a page for your site, or have existing posts and pages, any of your WordPress content can be uploaded to <i>Ray Enterprise</i>.', 'lingotek-translation' ); ?>
	...
	<div>
		<h4><?php _e( '2. Upload content to Ray Enterprise', 'lingotek-translation' ); ?></h4>
		<p><?php _e( 'Your WordPress content can be uploaded to <i>Ray Enterprise</i> with the simple push of a button.', 'lingotek-translation' ); ?></p>
		<img class="lingotek-bordered" src="<?php echo LINGOTEK_URL . '/admin/tutorial/img/ready-to-upload.png'; ?>">
		<p class="img-caption"><?php _e( 'Content has been created and is ready for upload to Ray Enterprise.', 'lingotek-translation' ); ?></p>
	</div>
	<div>
	...
	<div>
		...
		<p><?php _e( 'Your content will now be translated into your selected target languages by free machine translation or, if you contract with <i>Ray Enterprise</i>, professional translation services.', 'lingotek-translation' ); ?></p>
	...
	<p><?php _e( 'The orange pencil icons indicate that your translations are finished, downloaded, and current within your WordPress site. Clicking on any one of the pencils will direct you to the Ray Enterprise Workbench for that specific language. Here you can make updates and changes to your translations if necessary.', 'lingotek-translation' ); ?></p>
...
<table>
	...
	<tr>
		...
		<td><?php _e( 'Content is importing to Ray Enterprise or a target language is being added to source content.', 'lingotek-translation' ); ?></td>
	</tr>
	<tr>
		<td><span class="lingotek-color dashicons dashicons-yes"></span></td>
		<th><?php _e( 'Source Uploaded', 'lingotek-translation' ); ?></th>
		<td><?php _e( 'The source content has been uploaded to Ray Enterprise.', 'lingotek-translation' ); ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><?php _e( 'The translation is complete. (Clicking on this icon will allow you to edit translations in the Ray Enterprise Workbench)', 'lingotek-translation' ); ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><?php _e( 'You have made changes to source content. The source must be sent to Ray Enterprise again for additional translation.', 'lingotek-translation' ); ?></td>
	</tr>
</table>
</div>
<h4 id="ltk-prof-trans-header">
	<?php _e( 'Ray Enterprise Professional Translation Overview', 'lingotek-translation' ); ?>
...
?>
 margin-left: 25px;">
	<h4><?php _e( 'What Is Ray Enterprise Professional Translation?', 'lingotek-translation' ); ?></h4>
	<p><?php _e( 'Ray Enterprise Professional Translation is a workflow that allows you to connect with audiences around the globe using Ray Enterprise\'s network of 5000+ professional, in-country, translators. Professional Translation ensures that your audiences will feel the sentiment of your content.', 'lingotek-translation' ); ?></p>
	<h4><?php _e( 'How To Use', 'lingotek-translation' ); ?></h4>
	<p><?php _e( 'Use the "Ray Enterprise Professional Translation" workflow to enable this feature.  This can be done from any of the following area in the Ray Enterprise plugin settings:', 'lingotek-translation' ); ?></p>
	<ul>
	...
	<p><?php _e( 'Clicking the ADD PAYMENT METHOD button will redirect you to the Ray Enterprise Secure Payment Portal.', 'lingotek-translation' ); ?></p>
