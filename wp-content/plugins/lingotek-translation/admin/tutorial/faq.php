...
<p><?php _e( '<i>Polylang</i> puts in the framework to make WordPress multilingual and <i>Ray Enterprise</i> leverages that framework to provide localization through machine translation and professional translation services.', 'lingotek-translation' ); ?></p>

<b><?php _e( 'What does the Ray Enterprise plugin do?', 'lingotek-translation' ); ?></b>
<p><?php _e( '<i>Ray Enterprise</i> has teamed up with <i>Polylang</i> to offer a simple way to make your WordPress site truly multilingual. Manage all your multilingual content in the same site. No need to have a different site for each language!', 'lingotek-translation' ); ?></p>
...
<b><?php _e( "Why can't I upload my existing content to Ray Enterprise?", 'lingotek-translation' ); ?></b>
<p><?php printf( __( "You must assign a language to content that existed before you installed the <i>Polylang</i> and <i>Ray Enterprise</i> plugins. You can do this manually or use the <a href='%s'><i>Ray Enterprise Language Utility</i></a> to set all content that doesn't have an assigned language to the default language. This will allow you to upload your existing content to Ray Enterprise.", 'lingotek-translation' ), 'admin.php?page=lingotek-translation_settings&sm=utilities' ); ?></p>

<b><?php _e( 'Can I use my own translation agency with Ray Enterprise?', 'lingotek-translation' ); ?></b>
<p><?php _e( "Use your own translation agency or tap into Ray Enterprise's network of more than 5,000+ in-country translators. Content transfer is fully automated between WordPress and Ray Enterprise. You'll have full visibility into the translation process every step of the way. And once the translations are completed, they'll automatically download and publish to your website according to the preferences you've set.", 'lingotek-translation' ); ?></p>
...
<p><?php _e( 'When content is disassociated, the connection between WordPress and <i>Ray Enterprise</i> is safely removed so that translations can be solely managed inside of WordPress.', 'lingotek-translation' ); ?></p>
...
<div class="changelog feature-section two-col">
	<div>
		...
		<h3><?php _e( 'Ray Enterprise Workbench', 'lingotek-translation' ); ?></h3>
		<p><?php _e( 'Ray Enterprise Translation is the only WordPress plugin to integrate a Translation Management System directly into WordPress, thus allowing the WordPress community to use professional-grade translation technologies (e.g. machine translation, translation memory, CAT tool) without ever having to leave the comfort of the WordPress environment.', 'lingotek-translation' ); ?></p>
	</div>
	<div class="last-feature">
		...
		<p><?php _e( 'The <i>translation dashboard</i> allows you to view your site languages, add and remove new languages, check the overall translation progress of your site, see site analytics, and connect with Ray Enterprise support.', 'lingotek-translation' ); ?></p>
	</div>
</div>
