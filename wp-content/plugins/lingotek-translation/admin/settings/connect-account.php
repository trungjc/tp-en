...
<div class="wrap content">
	...
	<div>
	<p class="description">
	<?php esc_html_e( 'Get started by clicking the button below to connect your Ray Enterprise account to this WordPress installation.', 'lingotek-translation' ); ?>
	</p>
	<hr/>
	<p>
	<a class="button button-large button-hero" href="<?php echo esc_url_raw( $connect_account_cloak_url_new ); ?>">
		<img src="<?php echo esc_url_raw( LINGOTEK_URL ); ?>/img/rayEnterpriseIcon.svg" style="padding: 0 4px 2px 0; width: 25px" align="absmiddle"/> <?php esc_html_e( 'Connect New Account', 'lingotek-translation' ); ?>
	</a>
	</p>
	<hr/>
	<p class="description">
	<?php
		...
		echo sprintf( wp_kses( __( 'Do you already have a Ray Enterprise account? <a href="%s">Connect Ray Enterprise Account</a>', 'lingotek-translation' ), $allowed_html ), esc_attr( $connect_account_cloak_url_prod ) )
		?>
	</p>
	</div>
</div>
