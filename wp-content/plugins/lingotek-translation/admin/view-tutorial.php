...
<h1><?php printf( __( 'Welcome to Ray Enterprise', 'lingotek-translation' ) ); ?></h1>

<div class="about-text"><?php printf( __( 'Thank you for updating! Ray Enterprise offers convenient cloud-based localization and translation.', 'lingotek-translation' ), LINGOTEK_VERSION ); ?></div>


<div class="wp-badge" style="background: url(<?php echo LINGOTEK_URL; ?>/img/rayEnterpriseIcon.svg) center 24px/85px 80px no-repeat #fff; color: #666;"><?php printf( __( 'Version %s', 'lingotek-translation' ), LINGOTEK_VERSION ); ?></div>
