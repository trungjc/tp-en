...
Copyright 2018-21  wp-posts-widget  (email : raghunath.0087@gmail.com)
			...
			$va_post_HTML .='<div class="wp-post-widget-listing">';
			    ...
			    $divid ='';
					...
					if(is_singular())
					{
						...
						if($wpw_hide_date!=1)
							$va_post_HTML .='<div class="text"><div class=" d-flex flex-wrap f-14 mb-3"><span class="post-date date text-muted mb-0">'.get_the_date('',$post->ID).'</span><a class="term-name text-decoration-none" href="">Tin</a></a></div>';
							$va_post_HTML .='<span class="title"><a class="post-title" href="' . esc_url( $post_link ) . '">'. $post_data->post_title. '</a></span>';
							
							$va_post_HTML .= '<p class="paragraph f-16">'.substr(strip_tags(strip_shortcodes($post_data->post_excerpt)),0,$wpw_content_limit);
